...
private let log = Logger(subsystem: "com.mtkg.kuntraykun", category: "update")
...
struct UpdateService {
    static let repoFullName = "m-tkg/kuntraykun"
    static let apiBase = "https://api.github.com"
    private static let userAgent = "Kuntraykun"
    ...
    func downloadReleaseZip(_ release: ReleaseInfo, into directory: URL) async throws -> URL {
        ...
        let destination = directory.appendingPathComponent("Kuntraykun.zip")
